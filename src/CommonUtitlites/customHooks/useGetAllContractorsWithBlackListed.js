...
const useGetAllContractorsWithBlackListed = (status) => {
  const [data, setData] = useState([]);
  useEffect(() => {

    const fetchData = async () => {
      try {
        let response =  api.post('/get-contractors-with-blacklisted', {userId,role,userName})
...
export default useGetAllContractorsWithBlackListed;
