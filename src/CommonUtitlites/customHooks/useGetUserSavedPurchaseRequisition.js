...
const useGetUserSavedPurchaseRequisition = (status) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        let response =  api.post("/get-save-prEntry", { userId, role, userName })
...
export default useGetUserSavedPurchaseRequisition;
