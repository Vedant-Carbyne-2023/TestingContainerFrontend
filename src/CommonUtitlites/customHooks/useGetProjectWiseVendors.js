...
const useGetVendorsProjectWise = (id) => {
  const [data, setData] = useState([]);
  useEffect(() => {

    const fetchData = async () => {
      try {
        let response =  api.post('/vendor/get-vendors-projectWise', {projectId:id, userId,role, userName})
...
export default useGetVendorsProjectWise;
