...
const useGetAllInventoryProducts = (projectId, status) => {
  ...
  useEffect(() => {
    ...
    async function getProducts() {
        let result = api.post("/get-all-items", { projectId, userId, role, userName });
...
export default useGetAllInventoryProducts;
