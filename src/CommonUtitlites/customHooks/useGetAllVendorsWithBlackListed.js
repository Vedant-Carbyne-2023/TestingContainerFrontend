...
const useGetVendorsWithBlackListed = (status) => {
  const [data, setData] = useState([]);
  useEffect(() => {

    const fetchData = async () => {
      try {
        let response =  api.post('/vendor/get-vendors-with-blacklisted', {userId,role, userName})
...
export default useGetVendorsWithBlackListed;
