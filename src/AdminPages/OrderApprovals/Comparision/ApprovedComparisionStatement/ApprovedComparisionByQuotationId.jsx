    ...
    <div>
      <div>
        ...
        >
          ...
          <div className="row">
            <label>Remarks</label>
            <input className="form-control" value={props.remarks} disabled={true} />
          </div>
          ...
          <tfoot>
            <tr>
              ...
              {selectedVendors.map((selected, vendorIndex) => (
                ...
                >
                  <strong>{calculateVendorTotal(vendorIndex)}</strong>
                </td>
              ))}
            </tr>
            <tr>
              ...
              {selectedVendors.length !== 0 && (
                <td
                  ...
                  style={{ textAlign: "right", paddingRight: "3rem" }}
                >
                  <strong>{getLowestAmountVendorNames().lowestAmount}</strong>
                </td>
              )}
            </tr>
            <tr>
