...
// const MakePdfForMaterialIssueNote = async({ data }) => {
  // console.log(data);
  const createPDF = async({ data, tableData, billingAddress })=> {
          ...
          >
            ...
            <View style={styles.table}>
              ...
              <View style={[styles.tableRow, styles.tableHeader]}>
                ...
                <Text style={[styles.tableCell]}>Quantity Requested</Text>
              ...
              {tableData
                ...
                .map((row, index) => (
                  <View key={index} style={styles.tableRow}>
                    ...
                    <Text style={styles.tableCell}>{row.indentQuantity}</Text>
    ...
    saveAs(pdfData, `generatedMin/${data.minId}/${Date.now()}.pdf`);
    return "Done";
  };
