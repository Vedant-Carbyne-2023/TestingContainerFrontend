...
export default function MaterialRecieptNoteForm({ data, projectId }) {
  ...
  console.log(new Date(data.mrnDate))

  useEffect(() => {
    const getTable = async()=>{
      setLoading(true);

      let result = api.post('/get-mrnTable-by-mrnId', {userId,role,userName,mrnId:data.mrnsId})
        ...
        <form >
          ...
          <label htmlFor="contractorName">MR Requester Name</label>
            ...
            <div className="col-md-6">
              ...
              <div className="form-group">
                <label htmlFor="mrnDate">Material Recieved Date</label>
                <input
  className="form-control"
  type="date"
  placeholder="Date"
