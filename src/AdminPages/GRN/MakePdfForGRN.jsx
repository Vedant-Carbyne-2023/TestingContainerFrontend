...
// const MakePdfForMaterialIssueNote = async({ data }) => {
  // console.log(data);
  const createPDFForGrn = async({ data, tableData })=> {
            ...
            <View style={styles.container}>
              <View style={styles.formGrid}>
                <View style={styles.formRow}> 
                  <View style={styles.col}>
                    <Text style={styles.label}>Gate Receipt Note Id :</Text>
                    <Text style={styles.input}>{data.grnId}</Text>
                  </View>
                  <View style={styles.col}>
                    <Text style={styles.label}>Material Issue Note Id :</Text>
                    <Text style={styles.input}>{data.mrNo}</Text>
                  </View>
                  {/* <View style={styles.col}>
    ...
    saveAs(pdfData, `generatedGrn/${data.grnId}/${Date.now()}.pdf`);
    return "Done";
  };
