...
useEffect(() => {
  ...
  return (
    <div className='container-fluid'>
        ...
        <ComparisionByQuotationId data={data} setVendorId={(id)=>setVendor(id)} comparisionId={comparisionId} projectId={projectId} projectName={projectName} toggle={(toggle)=>setToggle(toggle)} prId={props.prId} vendors={selectedVendors}/>
