...
export default function Outward({projectId, itemSelected, gpName}) {
  const [data, setData] = useState([])
  useEffect(() => {
      const getData =  async() =>{
      let result = api.post('/stock-outward-gpWise&itemWise', {userId, role, userName, projectId:projectId, itemSelected:itemSelected, gpName})
