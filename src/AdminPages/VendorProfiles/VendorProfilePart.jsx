...
//   useEffect(() => {
// if(entry.productCategory && categoryOption){
//   console.log(entry.productCategory, categoryOption)
//  let data =  entry.productCategory? categoryOption.filter((option) => entry.productCategory.includes(option.value)):""
