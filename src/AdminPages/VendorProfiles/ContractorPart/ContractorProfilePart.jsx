...
const ContractorProfilePart = ({ entry, change }) => {
  ...
  const [selectedOrganisationOptions, setSelectedOrganisationOptions] =
    useState(
      entry.contractorCategory?
      organisationOptions.filter((option) =>
        entry.contractorCategory.includes(option.value)
      ):
      ""
    );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      payload.append("contractor_code",entry.contractor_code)
      ...
      const response = await api.post('/postContractordata', payload);
        ...
        <div className="col-md-6">
          <div className="form-group">
            ...
            <input
              ...
              type="text"
              id="contractorCode"
              defaultValue={entry.contractor_code}
              name="contractorCode"
            />
          </div>
          <div className="form-group">
            ...
            <input
              ...
              type="text"
              id="contractorName"
              defaultValue={entry.contractorName}
              name="contractorName"
            />
          </div>
          <div className="form-group">
            ...
            <input
              ...
              defaultValue={entry.contractorEmail}
        ...
        <div className="col-md-6">
          ...
          <div className="form-group">
            ...
            <input
              ...
              type="tel"
              id="contractorPhone"
              defaultValue={entry.contractorPhone}
        ...
        <div className="col-md-6">
          ...
          <div className="form-group">
            ...
            <input
              ...
              defaultValue={entry.contractorWebsite}
            />
          </div>
          {/* <OfficeAdd /> */}
          <div className="form-group">
            ...
            >
              <div className="form-group">
                ...
                <ReactQuill
                  ...
                  defaultValue={entry.paymentTerms?entry.paymentTerms:paymentTerms}
                  readOnly={!edit}
...
export default ContractorProfilePart;
