  ...
  const handleSubmit = async (e) => {
    ...
    html2pdf()
      ...
      .then(async function (pdfBlob) {
        ...
        // payload.append("productCategory",selectedOptions)
  ...
  return (
    <>
      <div className="title">
        ...
        <button className="btn" onClick={() => navigate("/admin/contractorProfile")}>
          {" "}
          Show Contractor Database
        </button>
        <button className="btn" onClick={() => navigate("/admin/contractorapproval")}>
