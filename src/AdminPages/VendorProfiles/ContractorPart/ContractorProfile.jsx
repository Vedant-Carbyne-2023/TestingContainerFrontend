...
import useGetAllContractorsWithBlackListed from "../../../CommonUtitlites/customHooks/useGetAllContractorsWithBlackListed";
...
export default function ContractorProfile() {
  ...
  let data = useGetAllContractorsWithBlackListed(deleted);
              ...
              <tr key={item._id}>
...

                {
                ...
                }
                 {
                        ...
                        {
                          role === 'SuperUser' &&
                          <td >{item.isApproved?item.isApproved.isApproved==true?"Approved":"Not Approved":""}</td>
                        }
                        {
                          role === 'SuperUser' &&
                          <td >{item.isApproved?item.isApproved.userName=="Vedant Joshi"?"Admin":item.isApproved.userName:"Admin"}</td>
                        }
              </tr>
            ))}
        </tbody>
