...
export default function BorewellModal({ data, closeModal }) {
      ...
      {data.length>0 && (
        <Modal show={showModal} onHide={handleCloseModal}>
          <Modal.Header closeButton>
            <Modal.Title>Borewell Dpr</Modal.Title>
          </Modal.Header>
          <Modal.Body>
