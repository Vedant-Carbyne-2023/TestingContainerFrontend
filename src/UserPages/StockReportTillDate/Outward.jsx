...
export default function Outward({projectId, itemSelected, dateTimeFrom, dateTimeTo}) {
    const [data, setData] = useState([])
    useEffect(() => {
        const getData =  async() =>{
        let result = api.post('/stock-outward-projectWise&itemWiseTillDate', {userId, role, projectId:projectId, itemSelected:itemSelected, dateTimeFrom, dateTimeTo})
