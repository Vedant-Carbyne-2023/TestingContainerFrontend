...
export default function PRShowModal({ data, onSubmitApprove, setStatus }) {
  ...
  const handleSubmit = async (e) => {
    ...
    value.storageLocation=data.storageLocation
    value.tableData=tableData
    value.employer=data.employer
    value.tpiMtcReport=data.tpiMtcReport
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6">
            ...
            <div className="form-group">
              <label htmlFor="indentStatus">PR Status</label>
              <input
                type="text"
                className="form-control"
                ...
                id="indentStatus"
                name="indentStatus"
                value={data.status === "Saved" ? "Saved" : (data.status ? "Approved" : "NotApproved")}
              />
            </div>
            <div className="form-group">
          ...
          <div className="col-md-6">
            <div className="form-group">
              <label htmlFor="block">Storage Location</label>
              <input
                type="text"
                className="form-control"
