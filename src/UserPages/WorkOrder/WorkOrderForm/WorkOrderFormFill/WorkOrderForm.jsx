...
import MakePdfForWorkOrder from "../WorkOrderFormModal/MakePdfForWorkOrder";
...
// console.log(props.pdfStatus)
  ...
  useEffect(() => {
    const getTemplateNames = async () => {
      let result = api.post("/get-wo-termsAndConditionTemplate", {userId,role});
      result = await errorHandler(result);
      // console.log(result);
  ...
  useEffect(() => {
    const getVendors = async () => {
      ...
      if(selectedValue==="Vendor"){
        ...
        response = await api.post('/get-vendors', { userId, role, userName });
  ...
  const handlePDF = async (e) => {
    ...
    if(selectedOption=='save'){
      result = api.post("/save-workOrder", formData);
      result = await errorHandler(result);
      ...
      result = api.post("/create-workOrder", formData);
      result = await errorHandler(result);
