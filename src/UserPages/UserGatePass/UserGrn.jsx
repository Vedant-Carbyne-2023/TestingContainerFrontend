...
export default function UserGrn({compPermission}) {
  ...
  return (
   <>
    ...
    <div
        ...
        { permissions.some(permission => permission.show===true)
            && (
            <button
              className={`btn ${
          ...
          && ( activeComponent && activeComponent === "create" &&
            ...
            <div className="row">
              <div className="col-md-12">
                <img src="../carbyne.jpg" style={{ float: 'left' }} alt="Carbyne Logo" />
    ...
    size={"large"}
      ...
      <div className="row">
        <div className="col-md-12">
          ...
          <p className="text-center mb-0">Uttar Pradesh, India Pin 201301</p>
          <p className="text-center mb-0">CIN No.-U74110UP1993PTC015005</p>
          <h4 className="text-center mt-3">Material Issue Note / Gate Pass</h4>
        </div>
      </div>
      <hr />
      <form onSubmit={handleFormSubmit} >
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <div className="row d-flex">
              ...
              <button className="btn btn-primary" style={{ borderRadius: '3rem', display: 'flex', margin: 'auto' }} type='button' onClick={() => print()}>
                Print
              </button>
            </div>
          </div>
