...
const BoqFormGpWise = ({permission}) => {
...
(projectId && selectedGp.id  && permission.some(perm => perm.add===true))?

            <form onSubmit={handleSubmit}>
              <EditableTable tableData={(data) => setTableData(data)} permission={permission}/>
...
<center><h6 className="form-select mt-4">Please Select Project And Gp First Or You May No Have Permission</h6></center>
            }
          </div>
          ...
          >
            {selectedItem && <UpdateBoqFormGpWise data={selectedItem} permission={permission}/>}
          </CustomModal>
        </div>
      }
    </>
