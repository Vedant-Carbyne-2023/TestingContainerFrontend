...
export default function UserVendorForm({compPermission}) {
...
const navigate= useNavigate()
  return (
    ...
    <button className="btn" disabled={!permissions.some(permission=>permission.show===true)} onClick={()=>navigate(`/user/vendorProfile/${permission._id}`)}> Show Vendor Database</button>
...
<div style={{ marginTop: '1rem' }}>
    ...
    :
   <h4>"You Does Not Have Permission Of Add Vendor "</h4>
    }
    </>
  );
}
