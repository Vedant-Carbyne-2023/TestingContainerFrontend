...
export default function AddProject({ submitStatus, add_permission, edit_permission }) {
...
<label>Enter New Project Code</label>
        ...
        <button type="submit" className="btn btn-secondary mt-3 d-flex mx-auto" disabled={!add_permission}>
          Submit
        </button>
      </form>
    </div>
