...
const ApprovedComparisionByQuotationId = (props) => {
...
const [comparisionApprovalRemark, setComparisionApprovalRemark] = useState('')
  ...
  useEffect(() => {
    if (props) {
      ...
      async function abc (){
      let result = api.post('/get-comparision-by-id',{userId,role,comparisionId:props.comparisionId})
      result = await errorHandler(result)
      // console.log(result.data.data)
      setComparisionApprovalRemark(result.data.data.remarks)}
  ...
  //     let result = api.post("/edit-comparision-by-id", {userId, role, comparisionId, remarks, isApproved:true})
  //   result = await errorHandler(result)
    ...
    <div>
      <div>
        ...
        <div className="col-md-12 my-2">
          <h6>Remarks From Approval Management</h6>
          <textarea
          className="form-control"
          readOnly
          value={comparisionApprovalRemark}
          />
            ...
            <tr>
              ...
              {selectedVendors.map((selected, vendorIndex) => (
                ...
                >
                  ...
                  formatIndianNumber(calculateVendorTotal(vendorIndex))}</strong>
                </td>
              ))}
            </tr>
            <tr>
              ...
              {selectedVendors.length !== 0 && (
                ...
                >
                  {selectedVendors.map((vendor) => (
                    <button
                      type="button"
                      disabled={!props.purchase_permission}
                      className="btn"
        ...
        {/* <div className="col d-flex"> */}
                      ...
                      {/* <textarea className="form-control" onChange={(e)=>setRemarks()} value={remarks}>Add Remarks </textarea> */}
                      {/* </div> */}
      </div>
    </div>
  );
...
export default ApprovedComparisionByQuotationId;
