...
useEffect(() => {
  ...
  return (
    <div className='container-fluid'>
        ...
        <ComparisionByQuotationId data={data} purchase_permission={props.purchase_permission} vendorId={props.vendorId} projectId={projectId} projectName={projectName} toggle={(toggle)=>setToggle(toggle)} prId={props.prId} setVendorId={(vendorId)=>setVendor(vendorId)}/>
